...
from .tools import MemoryFeedbackTool, MemoryFinishTool, MemoryRecallTool
...
class MyelinToolkit:
    ...
    The agent calls ``memory_recall``, ``memory_finish``
    ...
    def tools(self) -> list[Any]:
        return [self._recall_tool, self._feedback_tool, self._finish_tool]
